      ...
      <div class="container" id="nav2">
        ...
        @for ($x = 0; $x < count($urlpages); $x++)
            ...
            @if($urlpages[$x]=='page_top')
              <li>
                  <a class="page-scroll droid-arabic-kufi" href="{{url($subdomain.'/ar')}}">{{$ar_menupages[$x]}}</a>
              </li>
            @endif 
        ...
        @if($url_outside_pages)
          @for ($x = 0; $x < count($url_outside_pages); $x++)
            <li>
                  <a class="page-scroll droid-arabic-kufi" href="#{{str_replace(' ', '', str_replace('&', '', $url_outside_pages[$x]))}}">{{$ar_outside_menupages[$x]}}</a>
              </li>
              <?php 
              // $findpage_top=1;
