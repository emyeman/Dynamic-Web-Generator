...
<div class="col-sm-9">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <a class="btn btn-primary" href="#" >Edit Category</a><span class="glyphicon glyphicon-chevron-right"></span>

                <a class="btn btn-danger" href="#">Remove Category</a><span class="glyphicon glyphicon-chevron-right"></span>
            </div>
        </div>
        <!-- /.row -->
        <hr/>
