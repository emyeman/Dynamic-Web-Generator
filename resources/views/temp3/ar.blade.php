@include('../temp3/header')
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav hidden-lg hidden-md ">
        <li><a href="#head" class="active">الرئيسي</a></li>
        <li><a href="#about">من نحن</a></li>
        <li><a href="#gallery">المنتجات</a></li>
        <li><a href="#services">الخدمات</a></li>
        <li><a href="#news">الاخبار</a></li>
        <li><a href="#promotions">العروض</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">   
                ...
                <h1 class="title">الطبيعة</h1>
                <img src="assets/images/line.png"/>
                <h2 class="subtitle">عندما تلقي ما تستحق</h2>
            ...
            <!--    <h3 class="tagline">
                ...
                <p><a href="#about" class="btn btn-default btn-lg">تعرف علينا</a></p>
...
<section class="section" id="about">
    <div class="container">
        ...
        <h2 class="text-center title">من نحن</h2>
        <div class="row backg">
            ...
            <div class="col-sm-4 col-sm-offset-1">
                <div class="space"></div>
                <h5><strong>تعرف علينا<br></strong></h5>
                <p><b>مسارح البولندي هو به،. يبق إذ إعمار قتيل، وبحلول, أم العصبة والمعدات به،. حدى ٣٠ تزامناً الدّفاع, الى ان نقطة وقام لفشل.</b></p>
...
<section class="section" id="gallery">
    <div class="container">
        ...
        <h2 class="text-center title">المنتجات</h2>
                ...
                <li>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="#" data-filter=".web-design">نوكيا</a></li>
                            <li><a href="#" data-filter=".app-development">لينوفو</a></li>
                            <li><a href="#" data-filter=".site-building">سوني</a></li>
                            <li><a href="#" data-filter=".web-design, app-development,.site-building">كل الموبيل</a></li>
                        </ul>
                    </div>
                ...
                <li>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                            <li><a href="#" data-filter=".web-design">سوني</a></li>
                            <li><a href="#" data-filter=".app-development">لينوفو</a></li>
                            <li><a href="#" data-filter=".site-building">توشيبا</a></li>
                            <li><a href="#" data-filter=".web-design, app-development,.site-building">كل لاب توب</a></li>
                        </ul>
                    </div>
                ...
                <li>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu3">
                            <li><a href="#" data-filter=".web-design">سوني</a></li>
                            <li><a href="#" data-filter=".app-development">سمسونج</a></li>
                            <li><a href="#" data-filter=".site-building">ديل</a></li>
                            <li><a href="#" data-filter=".web-design, app-development,.site-building">كل التابلت</a></li>
                        </ul>
                    </div>
        ...
        <div class="isotope-container row grid-space-20" id="container">
            <div class="col-sm-4 col-sm-offset-2 isotope-item web-design">
                <div class="thumbnail">
                    <img src="assets/screenshots/sshot1.jpg" alt="">
                    <div class="caption">
                        <h3>اسم المنتج</h3>
                        <p> مسارح البولندي هو به،. يبق إذ إعمار قتيل، وبحلول, أم العصبة والمعدات به،. حدى ٣٠ تزامناً الدّفاع, الى ان نقطة وقام لفشل.</p>
                        <p><a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-1">اسم المنتج</a></p>
                    </div>
                    <!-- Modal -->
            ...
            <div class="col-sm-4 col-sm-offset-2 isotope-item app-development">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p><a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-2">تعرف علي المزيد</a></p>
                    </div>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="project-2-label">اسم المنتج</h4>
                                </div>
                                <div class="modal-body">
                                    <h3>نفاصيل المنتج</h3>
                                    <div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-2 isotope-item app-development">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p><a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-3">تعرف علي المزيد</a></p>
                    </div>
                    <!-- Modal -->
            ...
            <div class="col-sm-4 col-sm-offset-2 isotope-item web-design">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p><a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-4">اسم المنتج</a></p>
                    </div>
                    <!-- Modal -->
            ...
            <div class="col-sm-4 col-sm-offset-2 isotope-item site-building">
                <div class="thumbnail">
                    <img src="assets/screenshots/sshot3.jpg" alt="">
                    <div class="caption">
                        <h3>اسم المنتج</h3>
...
<section class="section" id="services">
    <div class="container">
        ...
        <h2 class="text-center title">الخدمات</h2>
            ...
            <div class="col-sm-8 col-sm-offset-2 text-center">
                    ...
                    <span class="fa-stack fa-4x">
                        ...
                        <i class="fa fa-shopping-cart fa-stack-1x"></i>
                                            ...
                                            <h4 class="service-heading">خدمة الكترنية</h4>
            ...
            <div class="col-sm-8 col-sm-offset-2 text-center">
                    ...
                    <span class="fa-stack fa-4x">
                        ...
                        <i class="fa fa-cogs fa-stack-1x"></i>
                                            ...
                                            <h4 class="service-heading">خدمة عملاء</h4>
                                            <p class="text-muted">ألمّ الشتاء بحث بل. أخر وصغار الأراضي للإتحاد ما, من يطول لإعلان بالفشل إيو.</p>
                                        </div>
                                    </div>
...
<section class="section" id="news">
    <div class="container">
        ...
        <h2 class="text-center title">الاخبار</h2>
            <div class="space"></div>
        <div class="row part" id="news1">

                            <div class="col-sm-6 col-md-4 col-md-offset-1">
                                        <img class="img-responsive" src="assets/images/body1.jpg"/>
                                    <a class="btn btn-default btn-block">افتتاح فرع جديد في وادي دجلا</a>
                                </div>
                                
                                <div class="col-sm-6 col-md-4 col-md-offset-2">
                                        <img class="img-responsive" src="assets/images/body2.jpg"/>
                                    <a class="btn btn-default btn-block">اعرف المزيد</a>
                                </div>
        ...
        <div class="row part" id="news2">
                            ...
                            <div class="col-sm-6 col-md-4 col-md-offset-1">
                                        <img class="img-responsive" src="assets/images/body1.jpg"/>
                                    <a class="btn btn-default btn-block">افتتاح فرع جديد في وادي دجل</a>
                                </div>
...
<section class="section" id="promotions">
    <div class="container">
        ...
        <h2 class="text-center title">العروض</h2>
            <div class="space"></div>
        <div class="row part box" id="promotion1">
                             ...
                             <div class="col-md-offset-1 col-md-4 ">
                                ...
                                <div class="col-md-4 col-md-push-2">
                                  ...
                                  <h3 class="text-center"> اسرع..لا تفكر كثيرا</h3>
                            <p class="text-center">ألمّ الشتاء بحث بل. أخر وصغار الأراضي للإتحاد ما, من يطول لإعلان بالفشل إيو</p>
                                    <div class="space"></div>
                                    <div>
                                        <p><a class="btn view center-block" role="button">اعرف المزيد</a></p>
                                    </div>
                                </div>
...
<section class="section" id="contact">
    <div class="container">
        ...
        <h2 class="text-center title">تواصل معنا</h2>

    <div class="row">
                        <div class="col-sm-6">
                            <div class="footer-content">
                                <ul class="list-icons">
                                    <li><i class="fa fa-map-marker pr-10"></i>12.شارع ابو بكر,الجيزة</li>
