...
<!-- *********************************************************************** -->
      ...
      <ul class="nav navbar-nav hidden-lg hidden-md ">
        ...
        @for ($x = 0; $x < count($urlpages); $x++)
            ...
            @if($urlpages[$x]=='page_top')
                 <li>
                    <a class="notaDiv" href="{{url($subdomain.'/en')}}">{{$en_menupages[$x]}}</a>
                </li>
            @endif 
            ...
            <?php $fstatic=0;?>
                @for ($x = 0; $x < count($url_outside_pages); $x++)
                    <li>
                        @if($fstatic==0)
                            <a  class="active" href="#{{str_replace(' ', '', str_replace('&', '', $url_outside_pages[$x]))}}">{{$en_outside_menupages[$x]}}</a>
                            <?php $fstatic=1;?>
                        @else
                            <a  href="#{{str_replace(' ', '', str_replace('&', '', $url_outside_pages[$x]))}}">{{$en_outside_menupages[$x]}}</a>
                        @endif    
                    </li>
                    <?php 
                    // $findpage_top=1;
    ...
    <div class="btn-group btn-default dropdown">
        ...
        <li class="space"></li>
            <li><a href="{{url('/'.$subdomain.'/static_page/ar')}}"class="notaDiv"><span class="lang-sm lang-lbl" lang="ar"></span></a></li>
            <li><a href="{{url('/'.$subdomain.'/static_page/en')}}" class="notaDiv"><span class="lang-sm lang-lbl" lang="en"></span></a></li>
        </ul>
        </div>      
        </div> 
