        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                  <a  href="{{url('/'.$subdomain.'/static_page/ar')}}"><span class="lang-sm lang-lbl" lang="ar"></span> <span class="caret"></span></a>
                  <ul class="dropdown">
                    <li>
                      <a href="{{url('/'.$subdomain.'/static_page/en')}}">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title"><?php echo $staticpages[$static];?></h4>
                    </div>
