 <header class="site-header-wrap">
        <div class="site-header">
            ...
            <a class="run" target="_blank" href="{{url('/webgenerator/'.Auth::user()->site->subdomain.'/'.Auth::user()->site->template_id.'/show_en')}}"><span class="glyphicon glyphicon-new-window"></span>Run</a>
            <!-- <nav class="site-nav">
