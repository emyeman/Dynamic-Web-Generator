 <header class="site-header-wrap">
        <div class="site-header">
            ...
            <a class="run" target="_blank" href="{{url('/webgenerator/'.Auth::user()->site->subdomain.'/'.Auth::user()->site->template_id.'/Home/show_en')}}"><span class="glyphicon glyphicon-new-window"></span>Run</a>
            <!-- <nav class="site-nav">
    ...
    <div class="main">
        <div class="accordion">
            <div class="accordion-section">
                <a class="accordion-section-title" href="#accordion-1"><!-- <span class="glyphicon glyphicon-time"></span> -->Branding  </a>
                <div id="accordion-1" class="accordion-section-content">

                        <ul class="nav nav-pills nav-stacked">
                            <li></li>
                            <li><a href="{{ url('/branding') }}">Show Branding</a></li>
                            <li><a href="{{ url('/branding/create')}}">Add Branding</a></li>
                        </ul>
...
<!--             <div class="accordion-section">
            ...
            <div class="accordion-section">
                ...
                <div id="accordion-3" class="accordion-section-content">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            <li></li>
                            <li><a href="{{ url('/page')}}">Show Pages</a></li>
                            <li><a href="{{ url('/page/create')}}">Add Page</a></li>
                        </ul>
            ...
            <div class="accordion-section">
                ...
                <div id="accordion-5" class="accordion-section-content">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            <li></li>
                            <li><a href="{{ url('/stylecontainer')}}">Show Style Container</a></li>
            ...
            <div class="accordion-section">
                ...
                <div id="accordion-12" class="accordion-section-content">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            <li></li>
                            <li><a href="{{ url('/footer')}}">Show Footer</a></li>
                            <li><a href="{{ url('/footer/create')}}">Add Footer</a></li>
                        </ul>
            ...
            <div class="accordion-section">
                ...
                <div id="accordion-13" class="accordion-section-content">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            <li></li>
                            <li><a href="{{ url('/numberview')}}">Show Number View</a></li>
