...
@section('content')
    ...
    <div class="row text-uppercase" style="text-align: center;">
        ...
        <img style="min-width: 30%;" src="{{url('assets/reseller_assets/images/4b.png')}}" class="img-responsive"> 
        </div>
        </div>
                 ...
                 <div class="box">
                    <div class="box-header">
                       ...
                       <div class="input-group-btn">
                           <div class="row">
                           <div class="col-md-4">
                             <a href="{{url('/menu')}}"><input id="add-new-event" type="button" class="btn btn-primary  pull-left "  value='Back' style="width:250px;"></a>
                            </div>
